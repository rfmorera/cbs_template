...
<div id="wrap_all">
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            ...
            <a class="navbar-brand">
                <?php if (true == of_get_option('logo')) { ?>
                    <picture><!--[if IE 9]>
                        ...
                        <source srcset="/../wp-content/uploads/2016/07/logo-blog-responsive.png"
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            ...
            $homeText = !$english ? 'Inicio' : 'Home';
            $blogText = !$english ? 'Noticias' : 'News';
            $blogLink = !$english ? 839 : 818;
            $menu_list = '<li><a href="/">' . strtoupper($homeText) . '</a></li>';
            $menu_list .= '<li><a href="/?page_id=' . $blogLink . '">' . strtoupper($blogText) . '</a></li>';
