...
function optionsframework_menu_settings() {
	...
	$menu = array(
		'page_title' => __( 'Parallax Me Theme Options', 'optionsframework'),
...
function optionsframework_load_scripts( $hook ) {
	...
	if ( !wp_script_is( 'wp-color-picker', 'registered' ) ) {
		wp_enqueue_script( 'iris', false, array( 'jquery','jquery-ui-draggable', 'jquery-ui-slider', 'jquery-touch-punch' ), false, true );
	...
	wp_enqueue_script( 'options-custom', OPTIONS_FRAMEWORK_DIRECTORY . 'js/options-custom.js', array( 'jquery','wp-color-picker' ), false, true );
...
function optionsframework_page() {
    ...
    <div id="optionsframework-metabox" class="metabox-holder">
		<div style="padding-bottom:10px;"><a href="<?php echo 'http://www.sktthemes.net/themes/skt_parallax_me_pro/';?>" target="_blank">Buy PRO version for only $30 with more features.</a></div>
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
			'parent' => 'appearance',
			'id' => 'of_theme_options',
			'title' => __( 'SKT Parallax Me Settings', 'options_framework_theme' ),
